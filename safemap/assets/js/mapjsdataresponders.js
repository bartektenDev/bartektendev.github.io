...
function initMap() {
    ...
    var victim1 = new google.maps.Marker({
        position: {lat: 41.994622, lng: -88.0782871},
        map: map,
        title: 'Victim',
        icon: './assets/images/victimneedshelp48.gif',
        draggable: false
      });

    var victim2 = new google.maps.Marker({
        position: {lat: 41.994622, lng: -88.0592871},
        map: map,
        title: 'Victim',
        icon: './assets/images/victimneedshelp48.gif',
        draggable: false
