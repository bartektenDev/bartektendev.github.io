...
<div id="controlsbottom">
  <div class="nav">
      <ul>
          <li>
              <a href="javascript:getUserLocationAndSet();">Reload Location</a>
          </li><li>
              <a href="#">Live Stream</a>
          </li><li>
              <a href='send_distress_call.php?sendcall=1'>Send Distress Call</a>
          </li><li>
              <a href="#popup1">Safety Checklist</a>
          </li>
      </ul>
  </div>
  <div>
...
<div id="legend"><h3>Legend</h3></div>
    <script src="./assets/js/mapjsdata.js"></script>
